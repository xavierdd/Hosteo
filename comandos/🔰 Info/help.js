        ...
        if (args[0]) {
            ...
            if (comando) {
                let embed = new Discord.EmbedBuilder()
                    ...
                    .setFooter({ text: `© desarrollado por XV | 2023`, iconURL: `https://media.discordapp.net/attachments/975931352891396136/1086416065401208833/ca77a948c7c528353f5e9a31e173f255.png?width=428&height=473` })
            ...
            .setColor(client.color)
            .setDescription(`Bot Multifuncional en desarrollo por \`XV\``)
            ...
            .addFields([{name: `✍ **__Escriba .help para obtener más información sobre un comando.__**`, value: `[\`!\`]()`}], )
            .setThumbnail(message.guild.iconURL({ dynamic: true }))
            .setFooter({ text: `Página 1 / ${categorias.length+1}\n© desarrollado por XV | 2023`, iconURL: `https://media.discordapp.net/attachments/975931352891396136/1086416065401208833/ca77a948c7c528353f5e9a31e173f255.png?width=428&height=473` })
